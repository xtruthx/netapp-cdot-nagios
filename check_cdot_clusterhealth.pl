...
# nagios: -epn
# --
# check_cdot_clusterhealth - Check Clusternode Health
...
check_cdot_clusterhealth.pl -H HOSTNAME -u USERNAME -p PASSWORD \
           [--perfdatadir DIR] [--perfdataservicedesc SERVICE-DESC] \
		   [--hostdisplay HOSTDISPLAY] \

=head1 DESCRIPTION

Checks the high availability and failover options of all nodes in the NetApp System and warns
if it deviates from best practice
